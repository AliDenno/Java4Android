    ...
    public double calculate(int size, int count) {
        ...
        for (int i = 0 ; i < simulation ; i++){
            ...
            while (counter < people) {
                ...
                int d = rnd.nextInt(High-Low) + Low;    // integer between 0 and D-1
                if (days[d]){
                    success++;
        ...
        System.out.println((success/simulation)*100);
        return (success/simulation)*100;
